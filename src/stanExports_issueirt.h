...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'issueirt', line 19, column 2 to column 16)",
                                                      " (in 'issueirt', line 20, column 2 to column 21)",
                                                      " (in 'issueirt', line 21, column 2 to column 24)",
                                                      " (in 'issueirt', line 22, column 2 to column 24)",
                                                      " (in 'issueirt', line 23, column 2 to column 20)",
                                                      " (in 'issueirt', line 24, column 2 to column 20)",
                                                      " (in 'issueirt', line 25, column 2 to column 21)",
                                                      " (in 'issueirt', line 26, column 2 to column 20)",
                                                      " (in 'issueirt', line 29, column 2 to column 27)",
                                                      " (in 'issueirt', line 30, column 2 to column 16)",
                                                      " (in 'issueirt', line 31, column 2 to column 23)",
                                                      " (in 'issueirt', line 32, column 2 to column 12)",
                                                      " (in 'issueirt', line 34, column 4 to column 57)",
                                                      " (in 'issueirt', line 35, column 4 to column 59)",
                                                      " (in 'issueirt', line 33, column 17 to line 36, column 3)",
                                                      " (in 'issueirt', line 33, column 2 to line 36, column 3)",
                                                      " (in 'issueirt', line 38, column 4 to column 45)",
                                                      " (in 'issueirt', line 39, column 4 to column 47)",
                                                      " (in 'issueirt', line 37, column 17 to line 40, column 3)",
                                                      " (in 'issueirt', line 37, column 2 to line 40, column 3)",
                                                      " (in 'issueirt', line 70, column 2 to column 37)",
                                                      " (in 'issueirt', line 72, column 4 to column 155)",
                                                      " (in 'issueirt', line 71, column 21 to line 73, column 3)",
                                                      " (in 'issueirt', line 71, column 2 to line 73, column 3)",
                                                      " (in 'issueirt', line 44, column 4 to column 26)",
                                                      " (in 'issueirt', line 45, column 4 to column 26)",
                                                      " (in 'issueirt', line 43, column 17 to line 46, column 3)",
                                                      " (in 'issueirt', line 43, column 2 to line 46, column 3)",
                                                      " (in 'issueirt', line 47, column 2 to column 55)",
                                                      " (in 'issueirt', line 49, column 4 to column 34)",
                                                      " (in 'issueirt', line 50, column 4 to column 31)",
                                                      " (in 'issueirt', line 54, column 4 to column 35)",
                                                      " (in 'issueirt', line 48, column 17 to line 55, column 3)",
                                                      " (in 'issueirt', line 48, column 2 to line 55, column 3)",
                                                      " (in 'issueirt', line 57, column 4 to column 30)",
                                                      " (in 'issueirt', line 58, column 4 to column 27)",
                                                      " (in 'issueirt', line 61, column 4 to column 39)",
                                                      " (in 'issueirt', line 62, column 24 to column 25)",
                                                      " (in 'issueirt', line 62, column 4 to column 28)",
                                                      " (in 'issueirt', line 63, column 4 to column 27)",
                                                      " (in 'issueirt', line 56, column 17 to line 64, column 3)",
                                                      " (in 'issueirt', line 56, column 2 to line 64, column 3)",
                                                      " (in 'issueirt', line 66, column 4 to column 151)",
                                                      " (in 'issueirt', line 65, column 21 to line 67, column 3)",
                                                      " (in 'issueirt', line 65, column 2 to line 67, column 3)",
                                                      ...
                                                      " (in 'issueirt', line 19, column 13 to column 14)",
                                                      " (in 'issueirt', line 20, column 18 to column 19)",
                                                      " (in 'issueirt', line 21, column 21 to column 22)",
                                                      " (in 'issueirt', line 22, column 21 to column 22)",
                                                      " (in 'issueirt', line 23, column 17 to column 18)",
                                                      " (in 'issueirt', line 24, column 17 to column 18)",
                                                      " (in 'issueirt', line 25, column 18 to column 19)",
                                                      " (in 'issueirt', line 29, column 24 to column 25)",
                                                      " (in 'issueirt', line 30, column 13 to column 14)",
                                                      " (in 'issueirt', line 31, column 20 to column 21)",
                                                      " (in 'issueirt', line 32, column 9 to column 10)",
                                                      " (in 'issueirt', line 70, column 30 to column 35)"};
...
public:
  ...
  inline std::string model_name() const final { return "model_issueirt"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_issueirt(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_issueirt_namespace::model_issueirt";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_issueirt_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_issueirt_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
