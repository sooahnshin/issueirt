...
#include "stanExports_dynamic_vmf.h"

RCPP_MODULE(stan_fit4dynamic_vmf_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_dynamic_vmf")
