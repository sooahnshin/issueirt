...
#include "stanExports_issueirt_vmf.h"

RCPP_MODULE(stan_fit4issueirt_vmf_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_issueirt_vmf")
