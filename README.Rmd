...
You can install the development version of `issueirt` from [GitHub](https://github.com/) with:
...
We can project legislators' ideal points on the issue-specific axis to generate single-dimensional, **issue-specific ideal points** as visualized below.
