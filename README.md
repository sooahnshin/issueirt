...
The `issueirt` package provides convenient one-shot functions to fit
IssueIRT models. These functions handle the entire workflow
(preprocessing, initial estimation, model fitting, and post-processing)
in a single call.
...
For more control over the fitting process, you can also use the
step-by-step approach described in the vignettes.
